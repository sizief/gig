  ...
  class CLI
    def initialize args 
      ...
      if api_results[:code] == 200
        ...
        downloader = Downloader.new Githubgrab::Helper::extract_image_urls(api_results[:body]), args.join("-")
        downloader.save_all
      else
...
# TODO: separate the logic from CLI so we can use Githubgrab with more interfaces